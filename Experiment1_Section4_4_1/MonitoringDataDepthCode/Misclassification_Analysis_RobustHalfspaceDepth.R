...
# MISCLASSIFICATION ANALYSIS: ROBUST HALFSPACE DEPTH
library(dplyr)
...
SRconditional_signal_misclass_rHD_allsizes <- as.array(c(round(SRconditional_signal_misclassified_size2000, 2), round(SRconditional_signal_misclassified_size3000, 2), round(SRconditional_signal_misclassified_size4000, 2)))
SRconditional_signal_corrclass_rHD_allsizes <- as.array(c(round(SRconditional_signal_corrclass_size2000, 2), round(SRconditional_signal_corrclass_size3000, 2), round(SRconditional_signal_corrclass_size4000, 2)))
